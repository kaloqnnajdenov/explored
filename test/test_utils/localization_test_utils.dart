...
const Map<String, dynamic> _enTranslations = {
  ...
  'progress_tap_find_region': 'Browse packs',
  'progress_current_region_label': 'Current selection',
  'progress_region_area_placeholder': 'Region area',
  'region_finder_title': 'Region Packs',
  'region_finder_search_hint': 'Search country, region, city',
  ...
  'region_pack_kind_country': 'Country',
  'region_pack_kind_region': 'Region',
  'region_pack_kind_city': 'City',
  'region_pack_kind_city_center': 'City Center',
  'region_detail_action_map': 'Map',
  'region_detail_search_hint': 'Search',
  ...
  'settings_region_packs_title': 'Downloaded Packs',
  'settings_region_packs_empty': 'No packs downloaded yet.',
  ...
  'pack_detail_summary_title': 'Pack summary',
  'pack_detail_summary_subtitle':
      'Progress details for this pack type are still being implemented.',
};
