...
const Map<String, dynamic> _enTranslations = {
  ...
  'menu_manual_explore': 'Manual explore',
  ...
  'manual_explore_mode_label': 'Mode',
  'manual_explore_mode_add': 'Add',
  'manual_explore_mode_delete': 'Delete',
  'manual_explore_apply_date_label': 'Apply date',
  'manual_explore_apply_date_now': 'Now',
  'manual_explore_undo': 'Undo',
  'manual_explore_redo': 'Redo',
  'manual_explore_discard': 'Discard',
  'manual_explore_save': 'Save',
  'manual_explore_cancel': 'Cancel',
  'manual_explore_controls_collapse': 'Collapse controls',
  'manual_explore_controls_expand': 'Expand controls',
  'manual_explore_discard_title': 'Discard changes?',
  'manual_explore_discard_message': 'You have unsaved edits. Discard them?',
  'manual_explore_delete_confirm_title': 'Confirm deletions',
  'manual_explore_delete_confirm_message': 'Delete {cells} cells and {points} points?',
};
